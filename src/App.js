...
function Leaderboard() {
  ...
  useEffect(() => {
    if ((activePage - 1) * 25 + 25 < searchData.length) {
      setLeaderss(
        searchData.slice((activePage - 1) * 25, (activePage - 1) * 25 + 25)
      );
    } else {
      setLeaderss(searchData.slice((activePage - 1) * 25));
    }
  ...
  //                     </DialogContent>
  //                     <DialogActions>
  //                         <button onClick={handleClose} color="primary" style={{ background: "#F2F1F1", border: "none", padding: 15, color: "white", borderRadius: 5, cursor: "pointer", marginRight: 10 }}>
  //                             Close
  //                         </button>
  //                     </DialogActions>
  //                 </Dialog>
      ...
      >
        <div className="items-center justify-center">
          <div className="font-sans text-center text-2x1 font-extrabold">
            <div className="text-black dark:text-white text-4xl text center font-extrabold mb-10 underline underline-offset-4 decoration-primary_red-1">
              <span className="text-primary_red-0" style={{ display: "block" }}>
                {" "}
        ...
        <div>
          <div className="py-5 px-0 xl:pb-12 xl:px-24 xl:pt-0 text-center">
              ...
              <div className="bg-white shadow-2xl dark:bg-black rounded-md px-0 sm:px-3 py-2 md:px-16 lg:py-4 relative inline-block w-28 md:w-auto">
                ...
                {totalData[1] !== undefined && (
                  <>
                    ...
                    />
                    <FontAwesomeIcon
                      className="invisible lg:visible w-8 h-8 rounded-full border-5 border-white absolute bottom-1/4 right-1/4 bg-gray-400 inline-block"
                      icon={faGithub}
                      size="2x"
                    />
              ...
              <div className="bg-white shadow-2xl dark:bg-black rounded-md px-0 sm:px-3 py-2 md:px-16 lg:py-4  relative inline-block w-28 md:w-auto">
                ...
                {totalData[0] !== undefined && (
                  <>
                    ...
                    />
                    <FontAwesomeIcon
                      className="invisible lg:visible w-10 h-10 rounded-full border-5 border-white absolute bottom-1/4 right-1/4 bg-yellow-400 inline-block"
                      icon={faGithub}
                      size="3x"
                    />
                    <h3 className="text-black dark:text-primary_red-0 font-semibold mt-4 text-xs sm:text-sm md:text-md">
                      1.{" "}
              ...
              <div className="bg-white shadow-2xl dark:bg-black rounded-md px-0 sm:px-3 py-2 md:px-16 lg:py-4 relative inline-block w-28 md:w-auto">
                ...
                {totalData[2] !== undefined && (
                  <>
                    ...
                    />
                    <FontAwesomeIcon
                      className="invisible lg:visible w-8 h-8 rounded-full border-5 border-white absolute bottom-1/4 right-1/4 bg-amber-900 inline-block"
                      icon={faGithub}
                      size="2x"
                    />
                    <h3 className="text-black dark:text-primary_red-0 font-semibold mt-2 text-xs sm:text-sm md:text-md">
            ...
            <div className="bg-sky-100 dark:bg-red-200 px-1.5 py-1.5 rounded-md mb-3">
              <p className="text-sky-700 dark:text-red-700 text-sm">
              ...
              <div className="table w-full">
                <div className="table-header-group">
                  <div className="table-row">
                    {columns.map((column) => {
                      <div
                        className="table-cell front-serif px-4 py-4 bg-black text-white dark:bg-primary_red-0 dark:text-black"
                        key={column.id}
                        align={column.align}
                        style={{ minWidth: column.minWidth }}
                      >
                                  ...
                                  return (
                                    ...
                                    >
                                      {column.id === "avatar" ? (
                                        ...
                                        <div className="flex realtive left-6 md:left-12 lg:left-24">
                                          <FontAwesomeIcon
                                            className="mr-5"
                                            icon={faGithub}
                                            size="2x"
